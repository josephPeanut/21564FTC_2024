...
public class Code2024 extends LinearOpMode {
 ...
 //   private Servo extendServo = null;
    ...
    // LIFT ARM
            ...
            // CrServo (dont know which does which)
            // OUTFEED
           ...
           //FORWARD POSITION
            ...
            if(gamepad2.dpad_left){
                ...
                ArmExtendPosition = 62;
            }
            ArmExtend.setTargetPosition(ArmExtendPosition);
            ...
            telemetry.addData("ArmExtendPosition",ArmExtend.getCurrentPosition());
            telemetry.update();
